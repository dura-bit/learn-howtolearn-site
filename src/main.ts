  ...
  tasks: [
    {
      ...
      videoDuration: '10:00',
      links: [
        { label: '📄 備考地圖模板', url: 'https://lifecheatslab.com/', type: 'article' },
      ],
    },
    {
      ...
      videoDuration: '12:00',
      links: [
        { label: '📺 申論架構教學', url: 'https://youtu.be/L3x21UezXZY', type: 'video' },
      ],
    },
    {
      id: 'study-rhythm',
  ...
  tasks: [
    {
      ...
      links: [
        { label: '📄 素材整理示範', url: 'https://lifecheatslab.com/', type: 'article' },
      ],
    },
    {
      id: 'issue-spotting',
    ...
    },
    {
      ...
      links: [
        { label: '📄 答題架構模板', url: 'https://lifecheatslab.com/', type: 'article' },
      ],
    },
    {
      id: 'current-affairs',
...
function renderMainContent(): void {
  ...
  html += `
    <div class="brand-hero" id="site-intro">
      ...
      <h1 class="brand-hero-title">國考學習大本營</h1>
  ...
  html += `
    <div class="info-banner">
      ...
      <div class="info-links">
        <a class="info-link purchase" href="https://lifecheatslab.com/" target="_blank" rel="noopener">🎓 查看課程與資源</a>
        <a class="info-link" href="https://lifecheatslab.com/darks" target="_blank" rel="noopener">👩‍🏫 認識覓蔬小姐</a>
  ...
  html += `
    ...
    <div class="footer-cta-area">
      <div class="cta-card community">
        <h3>🙋 想要更快進入狀態？</h3>
        <p>如果你正在準備國考，但覺得方向混亂、申論題卡關、讀書效率不穩，可以從這套學習站開始建立自己的備考系統。</p>
        <p class="community-highlight">💬 把讀書變成系統，把焦慮變成行動，把努力轉成分數。</p>
        <div class="cta-actions">
          <a class="cta-btn primary" href="https://lifecheatslab.com/" target="_blank" rel="noopener">🎓 查看完整課程與資源</a>
          <a class="cta-btn secondary" href="https://lifecheatslab.com/darks" target="_blank" rel="noopener">👩‍🏫 認識覓蔬小姐</a>
        </div>
      </div>
      ...
      <div class="cta-card newsletter">
        ...
        <a class="cta-btn primary" href="https://lifecheatslab.com/follow" target="_blank" rel="noopener">✉️ 追蹤最新資源</a>
      </div>
    </div>
  `;
